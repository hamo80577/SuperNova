    ...
    <section className="rounded-[16px] border border-[color:var(--sn-border)] bg-[color:var(--sn-sunken)] p-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex gap-3">
          <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#FFE8D9] text-[color:var(--tlb-orange-900)]">
            <Icon className="h-5 w-5" />
          </span>
          <div>
            <h3 className="text-lg font-semibold text-[color:var(--sn-ink)]">
              {context.title}
            </h3>
            <p className="mt-1 text-sm text-[color:var(--sn-muted)]">{context.subtitle}</p>
