...
export function AppLoadingOverlay({
  ...
  return (
    <div
      ...
      aria-live="polite"
      className={cn(
        "grid place-items-center bg-[#f6f6f4] transition-opacity duration-200 ease-out motion-reduce:transition-none",
    ...
    >
      <div className="w-full max-w-[220px] px-6 text-center">
        <div
          aria-hidden="true"
          className="mx-auto h-1.5 w-24 overflow-hidden rounded-full bg-slate-200"
        >
