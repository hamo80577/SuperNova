...
const PICKER_PERMISSIONS = [
  ...
  PermissionKeys.DEDUCTIONS_VIEW,
...
const CHAMP_PERMISSIONS = [
  ...
  PermissionKeys.REQUESTS_CREATE_DEDUCTION_PICKER,
  PermissionKeys.DEDUCTIONS_VIEW,
  PermissionKeys.APPROVALS_VIEW_PENDING,
  PermissionKeys.APPROVALS_DECIDE_BRANCH,
  PermissionKeys.USERS_VIEW_SELF,
  PermissionKeys.USERS_EDIT_OWN_PREFERENCES,
...
const AREA_MANAGER_PERMISSIONS = [
  ...
  PermissionKeys.REQUESTS_CREATE_TRANSFER_PICKER,
  PermissionKeys.REQUESTS_CREATE_DEDUCTION_PICKER,
  PermissionKeys.REQUESTS_CREATE_DEDUCTION_CHAMP,
  PermissionKeys.DEDUCTIONS_VIEW,
  PermissionKeys.APPROVALS_VIEW_PENDING,
...
const ADMIN_PERMISSIONS = [
  ...
  PermissionKeys.REQUESTS_CREATE_TRANSFER_PICKER,
  PermissionKeys.DEDUCTIONS_VIEW,
  PermissionKeys.DEDUCTIONS_POLICY_MANAGE,
